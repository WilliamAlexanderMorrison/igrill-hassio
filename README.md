...
My objectives were:
1. Be able to walk away from my grill and continue monitoring temperatures
1. Keep data within my home network when possible

## Hardware Components
1. iGrill v2
1. 2x Raspberry Pi 4 Model B, both running [Raspbian](https://www.raspberrypi.org/downloads/raspbian/)
...
** Make any other configuration changes as desired
* Follow the [troubleshooting](https://github.com/bendikwa/igrill#troubleshooting) instrucitons provided by bendikwa
